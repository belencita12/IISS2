  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-[150px]">
        <p className="text-myPurple-focus animate-pulse text-lg font-medium">Cargando...</p>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 bg-white rounded-lg shadow-lg border border-myPurple-tertiary/30 animate-fade-in">
      ...
      <div className="space-y-5">
        ...
        <DetailSection title="Detalles" value={appointment.details || "Sin detalles"} />
        ...
        <div className="border-b border-myPurple-tertiary/30 pb-3">
          ...
          <div className="ml-2 p-4 bg-myPurple-disabled/40 rounded-md shadow-sm space-y-1">
            <p className="text-myPurple-primary">Nombre: <span className="font-medium">{appointment.pet.name}</span></p>
            <p className="text-myPurple-primary">Raza: <span className="font-medium">{appointment.pet.race}</span></p>
            <p className="text-myPurple-primary">Dueño: <span className="font-medium">{appointment.pet.owner.name}</span></p>
          </div>
        </div>
