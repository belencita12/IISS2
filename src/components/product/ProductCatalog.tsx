...
const ProductCatalog = ({ token }: { token: string | null }) => {
    ...
    useEffect(() => {
        ...
        if (minPrice && maxPrice && Number(minPrice) > Number(maxPrice)) {
            toast("warning", "El precio máximo debe ser mayor o igual al precio mínimo.")
            return
        }
                    ...
                    {selectedTags.length > 0 && (
                        <div className="mt-4 mb-2">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-sm font-medium text-gray-700">Etiquetas seleccionadas:</span>
                            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    <aside className="w-full lg:w-[30%] bg-white rounded-lg border shadow-sm p-5 space-y-5 h-fit max-h-screen overflow-auto">
                        ...
                        <div>
                            ...
                            <TagFilter title="Etiqueta" selectedTags={selectedTags} onChange={onTagsChange} token={token || ""} />
                        </div>
                    </aside>
                        ...
                        {products.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center lg:w-[970px] bg-white border rounded-lg shadow-sm p-10 text-center min-h-[400px]">
                                ...
                                <p className="text-gray-500 max-w-md mb-6">
                                    No hay productos que coincidan con los filtros seleccionados. Intenta modificar tus criterios de
                                    búsqueda.
                                </p>
                                {hasActiveFilters && (
